...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('user.dashboard') }}" class="flex items-center p-2 text-gray-900 rounded-lg">
            ...
            <li>
                <a href="{{ route('user.reservation') }}" class="flex items-center p-2 text-gray-900 rounded-lg">
